...
const Dday_dummy = [
  {
    year: 2023,
    semester: 1,
    period: ["2023. 01. 31", "2023. 02. 03"],
    Dday: 22,
  },
  {
    year: 2023,
    semester: 2,
    period: ["2023. 08. 24", "2023. 08. 31"],
    Dday: 74,
  },
  {
    year: 2024,
    ...
    <>
      <DdayContainer>
        <DdayUl>
          ...
          <p>|</p>
          <LDdayLi>
            {Dday[count].year}년도 {Dday[count].semester}학기 수강신청
          </LDdayLi>
          <SDdayLi>
            {Dday[count].period[0]} - {Dday[count].period[1]}
          </SDdayLi>
          <p>|</p>
